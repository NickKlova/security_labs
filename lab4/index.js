...
function createUser(res, email, given_name, family_name, name, nickname, password) {
...
app.post('/api/register', (req, res) => {
    createUser(res, req.body.email, req.body.givenname, req.body.familyname, req.body.nickname, req.body.name, req.body.password);
    return;
});
